...
<div class="container clearfix fadeInUp animated">
    <div class="sixteen columns blogwrap">
        <?php
            ...
            $loop = new WP_Query( array( 'post_type' => 'portfolio', 'paged' => $paged ,'posts_per_page'=>30) );
            ?>
                ...
                <div class="container clearfix">
                    <div class="sixteen columns alpha">
                        <ul class="filter <?php echo ($filter == 'Fade') ? 'filterfade' : 'filtershuffle'; ?>">
                            <li class="active"><a href="#" class="filterall" data-value="*"> <?php _e('<!--:es-->TodosE<!--:--><!--:pb-->Todos<!--:-->', 'framework'); ?></a></li>
    ...
    <div class="clear"></div>
<?php
    $loop2 = new WP_Query( array( 'post_type' => 'portfolio', 'paged' => $paged ,'posts_per_page'=>6) );
?>
<?php wordpress_pagination($loop2->max_num_pages); ?>
