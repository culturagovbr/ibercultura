...
<p>
    <label for="<?php echo $this->get_field_id( 'title' ); ?>">
        <?php _e('<!--:es-->Contato título (OPICIONAL)E<!--:--><!--:pb-->Contato título (OPICIONAL)<!--:-->:', 'framework') ?>
    </label>
    <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
</p>
<p>
    <label for="<?php echo $this->get_field_id( 'url' ); ?>">
        <?php _e('<!--:es-->Contato página URLE<!--:--><!--:pb-->Contato página URL<!--:-->:', 'framework') ?>
    </label>
...
<p>
    <label for="<?php echo $this->get_field_id( 'buttontext' ); ?>">
        <?php _e('<!--:es-->Botão textoE<!--:--><!--:pb-->Botão texto<!--:-->:', 'framework') ?>
    </label>
