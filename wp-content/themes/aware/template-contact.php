        ...
        <div id="contact-form">
            <form action="<?php the_permalink(); ?>" id="contactform" method="post" class="contactsubmit">
                ...
                <div class="messagerow">
                    <label for="c_message">
                        <?php _e('<!--:es-->Mensaje<!--:--><!--:pb-->Mensagem<!--:-->', 'framework'); ?>
                    </label>
				...
				<div class="one_half">
					<div class="messagerow">
						<label for="c_captcha">
								<?php _e('<!--:es-->¿Cuánto es 5 - 1?<!--:--><!--:pb-->Quanto é 5 - 1?<!--:-->', 'framework');?>
						</label>
                ...
                <p>
                    ...
                    <input type="submit" name="c_submit" id="c_submit" class="button dark" value="<?php _e('<!--:es-->Enviar Mensaje<!--:--><!--:pb-->Enviar Mensagem<!--:-->', 'framework'); ?>"/>
                </p>
